...
class myntra_finder extends StatefulWidget {
  @override
  State<myntra_finder> createState() => _myntra_finderState();
}

class _myntra_finderState extends State<myntra_finder> {
        ...
        body: SingleChildScrollView(
          child: Container(
            ...
            decoration: BoxDecoration(
              gradient:
              LinearGradient( begin: Alignment.topCenter,end:Alignment.bottomCenter,colors: [ Color(0xFFFe83e8c),Colors.white54]
              ),
                          ...
                          Wrap(
                            ...
                            children: List<Widget>.generate(
                              _choicesList.length,
                                ...
                                return ChoiceChip(
                                  pressElevation: 21.0,
                                  selectedColor:  Color(0xFFFe83e8c),
                      ...
                      Container(
                          child: Row(
                            ...
                            children: [
                              ...
                              ElevatedButton(
                                style:ElevatedButton.styleFrom(
                                    backgroundColor: Color(0xFFFe83e8c)),
                                child:Row(
                                  mainAxisAlignment:MainAxisAlignment.center,
                                  children:[
                                    Icon(
